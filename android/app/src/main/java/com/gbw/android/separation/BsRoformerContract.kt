...
internal object BsRoformerContract {
    ...
    const val OUTPUT_FLOATS = STEM_COUNT * CHUNK_FRAMES * CHANNELS

    const val BYTES_PER_FLOAT = 4
    const val STFT_BYTES = INPUT_FLOATS * BYTES_PER_FLOAT
    const val MASK_BYTES = MASK_FLOATS * BYTES_PER_FLOAT
    const val OUTPUT_BYTES = OUTPUT_FLOATS * BYTES_PER_FLOAT
